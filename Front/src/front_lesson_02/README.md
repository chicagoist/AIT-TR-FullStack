...
<main>
    <section class="main-sections block-weight">
        <p>
            Киноискусство является уникальным и могущественным способом передачи историй, эмоций и идей. От момента
            своего
    ...
    <section class="main-sections">
        ...
        <ul>
            ...
            <li>
                Комедия: Комедийные фильмы созданы для развлечения и вызывают смех у зрителей. Они могут варьироваться
                от
                легких шуток до сатиры и черного юмора.
            </li>
            <li>
                Фантастика: Этот жанр исследует научные и фантастические концепции, часто перенося зрителей в
                параллельные
