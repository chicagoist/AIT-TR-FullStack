...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Employee salesManagerJohn = new SalesManager(4, "John", "Young", 160,
                20000, 0.1);

        Employee salesManagerJurgen = new SalesManager(1, "Jurgen", "Flint",
                100, 25000, 0.3);
...
WageEmployee{wage=140.0}Employee{id=3, firstName='Jane', lastName='Dou', hour=160.0}
WageEmployee{wage=40.0}Employee{id=4, firstName='Jane', lastName='Mac', hour=60.0}
SalesManager{salesVolume=20000.0, percent=0.1}Employee{id=4, firstName='John', lastName='Young', hour=160.0}
SalesManager{salesVolume=25000.0, percent=0.3}Employee{id=1, firstName='Jurgen', lastName='Flint', hour=100.0}
